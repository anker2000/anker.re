	...
	<body class="home pre">
			...
			<div class="get_tickets">
				<button onclick="document.location.href='planning.php';" class="buy" disabled="true"><span>Book tickets</span><span>Tickets from £12</button><button onclick="$('body').toggleClass('pre');$(window).scrollTop(0);" disabled="true">See departures</button>
			</div>
		...
		<div class="station_screen">
			...
			<div class="station_list">
				<ul>
					...
					<li class="bookmark">Home (London Euston)</li>
