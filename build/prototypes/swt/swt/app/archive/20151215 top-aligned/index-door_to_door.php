	...
	<body class="search_station"><a href="planning.php" class="touch_test"></a>
		...
		<footer>There is a <a href="#">cheaper route</a> that takes 20min longer.</footer>
			...
			<div class="screen route_vertical">
				...
				<div class="route_container">
					...
					<ul>
						...
						<li class="first_station"><strong><a href="javascript:void()">London Euston</a></strong></li>
						<li class="change_station">1 possible change</li>
						<li class="last_station"><strong><a href="javascript:void()">Birmingham New St</a></strong><br><small>closest station</small></li>
						<li class="destination">Birmingham Arena</li>
					</ul>
				</div>
			...
			<div class="search_station">
				<img src="img/logo.svg" width="180" class="logo">
				...
				<img src="img/icon_controlsback.svg" class="scroll_indicator">
			</div>
