	...
	<body class="schedule step1"><a href="planning.php" class="touch_test"></a>
		...
		<header class="itinerary_container">
			<div class="price"><span class="amount">£00.00</span>Cheapest total</div>
			<div class="stations"><a href="#">WAT<span class="arrow return"></span>CLJ</a></div>
		...
		<header class="outbound table">
			...
			<datetime data-date="OCT 13 2015"><!-- <span class="peakvalue"></span>  -->OCT 13 2015</datetime><span class="label">Addition to total</span>
		</header>
		<header class="returning table">
			<h3>Returning train</h3>
			<datetime data-date="OCT 13 2015"><!-- <span class="peakvalue"></span>  -->OCT 23 2015</span></datetime><span class="label">Addition to total</span>
		</header>
		...
		<div class="swt_modal">
			...
			<div class="departure_controls">
				...
				<div class="svg_container" id="chartContainer">
		...
		<a href="#" class="filters react no_delay_button"><span></span></a>
