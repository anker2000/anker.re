	...
	<body class="planning">
			...
			<div class="container">
				<div class="row stations">
					...
					<script>if ($(".touch_test").css("display")!="inline") {
						$("#from").val("London Euston");
						$("#to").val("Birmingham New Street");
						}</script>
				</div>
				<div class="inset">
				...
				<button class="no_delay_button next buy" onclick="window.scrollTo(0, 0); document.location.href='schedule.php'">Tickets from <span class="amount">£6</span></button>
			</div>
			<br style="clear:both"/>
		...
		shoe room</h3>
			...
			<img src="img/gfx-eccentric_route.svg" class="eccentric_route">
		<script>
