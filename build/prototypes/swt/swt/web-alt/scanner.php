	...
	<body class="home">
			...
			<div class="top">
				...
				<br style="clear:both;"><div class="station opacityZero">From <a href="#" class="location">London Waterloo</a></div>
			...
			<div class="bottom">
					<div class="station opacityZero">To <a href="#" class="location">Sandown</a></div>
				<div class="clock_slider bottomslider opacityZero">
					<div class="options">	
						<?php
						$date=new DateTime();
						$datestr = $date->format('Y-m-d');
						$datetime=new DateTime($datestr . " 07:55:00");
						for ($i=0;$i<33;$i++) {
							echo('<span>');
							$datetime->modify('+105 minutes');
			...
			<div class="get_tickets opacityZero">
				<button onclick="document.location.href='planning.php';">Tickets from £22.5</button>
